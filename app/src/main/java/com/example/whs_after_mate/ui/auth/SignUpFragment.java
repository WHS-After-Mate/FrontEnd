...
public class SignUpFragment extends Fragment {
    ...
    private void observeViewModel() {
        ...
        signUpViewModel.getSignUpFormState().observe(getViewLifecycleOwner(), formState -> {
            ...
            binding.etName.setError(formState.getNameError());
            binding.etEmail.setError(formState.getEmailError());
            binding.etPhone.setError(formState.getPhoneError());
            binding.etPassword.setError(formState.getPasswordError());
        });
